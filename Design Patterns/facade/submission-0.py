...
class DriveThruFacade:
    ...
    def takeOrder(self, orderContents: str, takeOut: bool) -> Food:
        ...
        if takeOut:
            return self.kitchenStaff.packageOrder(self.chef.prepareFood(self.cashier.takeOrder(orderContents, takeOut)))
        return self.chef.prepareFood(self.cashier.takeOrder(orderContents, takeOut))
